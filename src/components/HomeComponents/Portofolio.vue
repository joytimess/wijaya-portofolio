...
<template>
    <section id="portofolio" class="px-80 py-20 bg-slate-200">
        <!-- TITLE PORTOFOLIO -->
        <div>
            <h2 class="text-center text-2xl text-[#0259DD] font-semibold uppercase">Portofolio</h2>
            <h1 class="text-center text-4xl font-bold mt-5">Project Terbaru</h1>
            <div class="flex justify-center">
                <p class="text-center mt-3 inline-block w-125">Berikut adalah progress project-project yang pernah saya kembangkan sebagai pengembang website.</p>
            </div>
        </div>
        <!-- PORTOFOLIO LATEST -->
        <div class="flex items-center gap-10 mt-10">
            <div class="relative group w-1/3 bg-[#FF6648] h-100 rounded-4xl overflow-hidden">
                <div class="
                    absolute 
                    top-6 left-6
                    w-20
                    ...
                    <i data-feather="link" class="w-7 h-7 text-white"></i>
                </div>
                <div class="py-5">
        ...
        <!-- SUPPORT PORTOFOLIO -->
        <div class="flex items-center gap-10 mt-10">
            <div class="relative group w-2/3 bg-[#00A0DC] h-100 rounded-4xl overflow-hidden">
                <div class="
                    absolute 
                    top-6 left-6
                    w-20
            ...
            <div class="relative group w-1/3 bg-[#ED3F27] h-100 rounded-4xl overflow-hidden">
                <div class="
                    absolute 
                    top-6 left-6
                    w-20
        ...
        <div class="relative group w-full bg-[#0259DD] h-100 rounded-4xl overflow-hidden mt-10">
            <div class="
                absolute 
                top-6 left-6
                w-20
            ...
            <div class="py-5">
                <p class="text-right px-5 text-2xl text-white font-semibold">Portofolio Pribadi</p>
            </div>
            <img :src="portofolioSelf" alt="portofolio-pribadi.jpg" 
                class="
